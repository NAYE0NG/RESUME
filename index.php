    ...
    <div id='overflow-area'>
            ...
            <div class='wrap-title'>
                        ...
                        <ul class="project-slider">
                            <li value='1'>
                                <figure class='project-list'>
                                    <div id='img1' class='projectImg'></div>
                            ...
                            <li value='2'>
                                <figure class='project-list'>
                                    <div id='img2' class='projectImg'></div>
                                    <figcaption class='wrap-project-txt'>
                                        <p class='proj-title'>WEATHER INFORMATION
                                            <br />
                            ...
                            <li value='3'>
                                <figure class='project-list'>
                                    <div id='img3' class='projectImg'></div>
                                    <figcaption class='wrap-project-txt'>
                                        <p class='proj-title'>NAVER CAFE ALARM
                                            <br />
                                            <span>Chrome Extension App</span>
                                        </p>
                                        <div class='proj-con'>
                            ...
                            <li value='4'>
                                <figure class='project-list'>
                                    <div id='img4' class='projectImg'></div>
                                    <figcaption class='wrap-project-txt'>
                                        <p class='proj-title'>개인 홈페이지
                                            <br />
                                            <span>Website</span>
                                        </p>
                                        <div class='proj-con'>
                            ...
                            <li value='5'>
                                <figure class='project-list'>
                                    <div id='img5' class='projectImg'></div>
                                    <figcaption class='wrap-project-txt'>
                ...
                <script>
                    ...
                    $('.nextBtn').click(function () {
                        var left_indent = parseInt($('.project-slider').css('left')) - item_width; //
                        $('.project-slider').animate({ 'left': left_indent + 'px' }, 300, function () {
        ...
        <section id='section3'>
            <div class='wrap-title'>
                ...
                <p class='border-orange in_bl f_l'></p>
                <div id='wrap-contact'>
                    <article class='in_bl f_l wth_40'>
                    ...
                    <article class='in_bl f_l wth_40'>
                        <div id='contact2'>
                            <div class='message-form'>
                                <form action="#" accept-charset="utf-8" name="message" method="post" id='message'>
                                    <input type="text" name="usrname" value='YOUR NAME' />
                                    <input type="email" name="usrmail" value='EMAIL ADDRESS' />
                                    <textarea rows="5" name="comment" style="resize: none;"></textarea>
                                </form>
                                <div id='submit-btn'>SEND MESSAGE</div>
                            </div>
                        </div>
                    </article>
                </div>
